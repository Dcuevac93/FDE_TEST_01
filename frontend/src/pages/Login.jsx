    ...
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="email" className="block text-sm/6 text-left font-medium text-gray-100">Email address</label>
            <div className="mt-2">
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-400">
          Not a member?
          <Link to="/register" className="font-semibold text-indigo-400 hover:text-indigo-300 pl-2">Register Here</Link>
        </p>
      </div>
    </div>
  );
